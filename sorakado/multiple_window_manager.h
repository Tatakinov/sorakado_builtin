#ifndef SORAKADO_MULTIPLE_WINDOW_MANAGER_H_
#define SORAKADO_MULTIPLE_WINDOW_MANAGER_H_
...
namespace sorakado {
    ...
    class MultipleWindowManager : public WindowManager {
        private:
            std::unordered_map<display_t, std::unique_ptr<Window>> windows_;
        public:
            MultipleWindowManager(std::unique_ptr<WindowFactory> factory, std::unique_ptr<BackendWindowFactory> backend_factory);
...
#endif // SORAKADO_MULTIPLE_WINDOW_MANAGER_H_
